...
module.exports = {
  ...
  src_folders: ['./nightwatch/src/tests'],
  ...
  test_settings: {
    ...
    safari: {
      ...
      webdriver: {
        ...
        start_process: true,
        server_path: './node_modules/chromedriver/bin/chromedriver.exe',
      }
    },
    ...
    chrome: {
      ...
      webdriver: {
        log_path: 'C:\\Users\\mauri\\nightwatch\\chromedriver.log',
        start_process: true,
        server_path: 'C:\\Users\\mauri\\Downloads\\chromedriver-win64 (1)\\chromedriver-win64\\chromedriver.exe',
        cli_args: [
          // --verbose
        ]
      }
