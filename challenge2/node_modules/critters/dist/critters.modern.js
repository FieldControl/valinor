  ...
  async processStyle(style, document) {
    ...
    if (options.pruneSource) {
      ...
      if (styleInlinedCompletely) {
        const _percent = sheetInverse.length / before.length * 100;

        afterText = `, reducing non-inlined size ${_percent | 0}% to ${prettyBytes(sheetInverse.length)}`;
      }
...
//# sourceMappingURL=critters.modern.js.map
