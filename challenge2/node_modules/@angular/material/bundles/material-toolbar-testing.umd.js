(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@angular/material/toolbar/testing', ['exports', '@angular/cdk/testing'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.ng = global.ng || {}, global.ng.material = global.ng.material || {}, global.ng.material.toolbar = global.ng.material.toolbar || {}, global.ng.material.toolbar.testing = {}), global.ng.cdk.testing));
    ...
    ***************************************************************************** */
    ...
    var MatToolbarHarness = /** @class */ (function (_super) {
         ...
         */
        MatToolbarHarness.with = function (options) {
            if (options === void 0) { options = {}; }
            return new testing.HarnessPredicate(MatToolbarHarness, options)
                .addOption('text', options.text, function (harness, text) { return testing.HarnessPredicate.stringMatches(harness._getText(), text); });
        };
        /** Whether the toolbar has multiple rows. */
        MatToolbarHarness.prototype.hasMultipleRows = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.host()];
                        case 1: return [2 /*return*/, (_a.sent()).hasClass('mat-toolbar-multiple-rows')];
                    }
                });
            });
        };
        /** Gets all of the toolbar's content as text. */
        MatToolbarHarness.prototype._getText = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.host()];
    ...
    exports.MatToolbarHarness = MatToolbarHarness;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=material-toolbar-testing.umd.js.map
