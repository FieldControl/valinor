...
(function (factory) {
    ...
    var InlineResourcesMetadataTransformer = /** @class */ (function () {
        ...
        InlineResourcesMetadataTransformer.prototype.updateDecoratorMetadata = function (loader, arg) {
            ...
            styles.push.apply(styles, tslib_1.__spreadArray([], tslib_1.__read(styleUrls.map(function (styleUrl) { return loader.get(styleUrl); }))));
            if (styles.length > 0) {
                arg['styles'] = styles;
        ...
        componentArg.properties.forEach(function (prop) {
            ...
            switch (prop.name.text) {
                case 'styles':
                    ...
                    newStyleExprs.push.apply(newStyleExprs, tslib_1.__spreadArray([], tslib_1.__read(prop.initializer.elements)));
                    break;
                case 'styleUrls':
                    if (!ts.isArrayLiteralExpression(prop.initializer)) {
                        throw new Error('styleUrls takes an array argument');
                    }
                    newStyleExprs.push.apply(newStyleExprs, tslib_1.__spreadArray([], tslib_1.__read(prop.initializer.elements.map(function (expr) {
