...
(function (factory) {
    ...
    function transformSourceFile(sourceFile, requests, context) {
        ...
        var min = Math.min.apply(Math, tslib_1.__spreadArray([], tslib_1.__read(locations)));
        var max = Math.max.apply(Math, tslib_1.__spreadArray([], tslib_1.__read(locations)));
        ...
        function visitSourceFile(sourceFile) {
            ...
            if (inserts.length) {
                ...
                /* modifiers */ undefined, ts.createNamedExports(inserts
                    .reduce(function (accumulator, insert) { return tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(accumulator)), tslib_1.__read(insert.declarations)); }, [])
