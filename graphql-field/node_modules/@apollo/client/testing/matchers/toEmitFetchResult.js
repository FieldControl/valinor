...
export var toEmitFetchResult = function (actual, expected, options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    stream = actual;
                    hint = this.utils.matcherHint(this.isNot ? ".not.toEmitFetchResult" : "toEmitFetchResult", "stream", "expected");
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                ...
                case 2:
                    ...
                    return [2 /*return*/, {
                            ...
                            message: function () {
                                ...
                                return (hint +
                                    "\n\n" +
                                    _this.utils.printDiffOrStringify(expected, value_1, "Expected", "Received", true));
                            },
                        }];
                case 3:
                    error_1 = _a.sent();
...
//# sourceMappingURL=toEmitFetchResult.js.map