	...
	return (
		<main className="flex flex-col justify-evenly px-64 pb-64 pt-10">
			<div className="flex flex-col bg-gray-800 rounded p-8 gap-5 font-sans text-white">
				...
				<div className="text-2xl my-3 w-full bg-gray-600 rounded p-2">Interpretation and Definitions</div>
				<div className="text-xl my-1 font-bold">Interpretation</div>
				<p>
					The words of which the initial letter is capitalized have meanings defined under the following conditions. The
					following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
				</p>
				<div className="text-xl my-1 font-bold">Definitions</div>
				...
				<ul>
					...
					<li className="pl-5">
						<p>
							...
							or &quot;Our&quot; in this Agreement) refers to URL Analyzer.
						</p>
					</li>
					<li className="pl-5">
						<p>
					...
					<li className="pl-5">
						<p>
							- <strong>Website</strong> refers to URL Analyzer, accessible from{' '}
							<a href="url-analyzer.jpbm.dev" rel="external nofollow noopener" target="_blank">
								url-analyzer.jpbm.dev
							</a>
						</p>
					</li>
					<li className="pl-5">
				...
				<div className="text-2xl my-3 w-full bg-gray-600 rounded p-2">Collecting and Using Your Personal Data</div>
				<div className="text-xl my-1 font-bold">Types of Data Collected</div>
				<div className="font-bold">Personal Data</div>
				<p>
				...
				<div className="font-bold">Usage Data</div>
				...
				<div className="font-bold">Information from Third-Party Social Media Services</div>
				<p>
					The Company allows You to create an account and log in to use the Service through the following Third-party
					Social Media Services:
				</p>
				<ul>
					<li className="pl-5">Google</li>
					<li className="pl-5">Microsoft</li>
					<li className="pl-5">GitHub</li>
					<li className="pl-5">Discord</li>
				</ul>
				<p>
				...
				<div className="text-xl my-1 font-bold">Use of Your Personal Data</div>
				...
				<div className="text-xl my-1 font-bold">Retention of Your Personal Data</div>
				<p>
				...
				<div className="text-xl my-1 font-bold">Transfer of Your Personal Data</div>
				<p>
				...
				<div className="text-xl my-1 font-bold">Delete Your Personal Data</div>
				<p>
				...
				<div className="text-xl my-1 font-bold">Disclosure of Your Personal Data</div>
				...
				<ul>
					<li className="pl-5">Comply with a legal obligation</li>
					<li className="pl-5">Protect and defend the rights or property of the Company</li>
					<li className="pl-5">Prevent or investigate possible wrongdoing in connection with the Service</li>
					<li className="pl-5">Protect the personal safety of Users of the Service or the public</li>
					<li className="pl-5">Protect against legal liability</li>
				</ul>
				<div className="text-xl my-1 font-bold">Security of Your Personal Data</div>
				<p>
				...
				<div className="text-2xl my-3 w-full bg-gray-600 rounded p-2">Children's Privacy</div>
				<p>
				...
				<div className="text-2xl my-3 w-full bg-gray-600 rounded p-2">Links to Other Websites</div>
				<p>
				...
				<div className="text-2xl my-3 w-full bg-gray-600 rounded p-2">Changes to this Privacy Policy</div>
				<p>
				...
				<div className="text-2xl my-3 w-full bg-gray-600 rounded p-2">Contact Us</div>
				<p>If you have any questions about this Privacy Policy, You can contact us:</p>
				<ul>
					<li className="pl-5">By email: jpedrobm0@gmail.com</li>
				</ul>
				<div className="text-gray-400">
					<p>
						This Privacy Policy has been created with the help of the{' '}
						<a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" rel="noreferrer" target="_blank">
