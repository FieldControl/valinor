export enum HttpErrorCodes {
	...
	CharsetUnsupported = 'Charset not supported, use only UTF-8',
	EncodingNotSupported = 'Encoding not supported',
	EntityParseFailed = 'Failed to parse the entity',
	...
	ParametersTooMany = 'Too many parameters',
	RateLimit = 'You are making too many requests, please try again later',
	RequestAborted = 'Request aborted',
	RequestSizeInvalid = 'Invalid request size',
	RouteNotFound = 'Route not found',
	StreamEncodingSet = 'Stream encoding set',
	UnauthorizedToken = 'The provided token is not valid',
	UnsupportedContentType = 'Unsupported content type',
	UserAlreadyExists = 'A user is already registered with this email',
	UserInactive = 'This user is inactive and cannot log in',
	ValidationFailed = 'Data validation failed',
}

export enum RawBodyErrorType {
	'charset.unsupported' = 'CharsetUnsupported',
	'encoding.unsupported' = 'EncodingNotSupported',
	'entity.parse.failed' = 'EntityParseFailed',
	'entity.too.large' = 'EntityTooLarge',
	'entity.verify.failed' = 'EntityVerifyFailed',
	'parameters.too.many' = 'ParametersTooMany',
	'request.aborted' = 'RequestAborted',
	'request.size.invalid' = 'RequestSizeInvalid',
	'stream.encoding.set' = 'StreamEncodingSet',
}
