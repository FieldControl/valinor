...
import { ResponseSpecie } from 'src/app/shared/specie.models';
...
export class SpeciesService {
  ...
  public getSpecies(search: string, page: number) {
    const params = this.requestParams(search, page);
    const url = this.apiURL + 'species';
    return this.http.get<ResponseSpecie>(url, { params });
  }
