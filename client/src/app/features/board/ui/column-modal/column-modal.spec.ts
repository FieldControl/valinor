...
describe('ColumnModal', () => {
  let component: ColumnModal;
  let fixture: ComponentFixture<ColumnModal>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(ColumnModal);
  ...
  it('deve preencher o formulário se estiver no modo de edição', () => {
    // Cenário de Edição
    component.mode = 'edit';
    component.columnData = { id: 10, title: 'Coluna teste' };
    
    // Forçamos o ngOnInit de novo
    component.ngOnInit();

    // Verifica se o formulário puxou o dado
    expect(component.form.get('title')?.value).toBe('Coluna teste');
  });
});