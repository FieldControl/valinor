...
var chunk_YZCP3T5L_exports = {};
__export(chunk_YZCP3T5L_exports, {
...
module.exports = __toCommonJS(chunk_YZCP3T5L_exports);
var import_chunk_ET5XKFXO = require("./chunk-ET5XKFXO.js");
...
var init_binaryTargetRegex = (0, import_chunk_UPBZT3NW.__esm)({
  "src/test-utils/binaryTargetRegex.ts"() {
    ...
    (0, import_chunk_ET5XKFXO.init_binaryTargets)();
    binaryTargetRegex = new RegExp(
      "(" + [...import_chunk_ET5XKFXO.binaryTargets].sort((a, b) => b.length - a.length).map((p) => (0, import_escape_string_regexp.default)(p)).join("|") + ")",
      "g"
    );
  }
});
