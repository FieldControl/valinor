...
export class AddCardComponent {
  ...
  private _updateCard() {
    this.cardService
      .updateCard(this.data.card?.idCard, this.addCardForm.value as Partial<ICard>)
  ...
  deleteCard() {
    if (!this.data.card?.idCard) return;
    this.matDialog
      ...
      .pipe(
        ...
        mergeMap(() => this.cardService.deleteCard(this.data.card.idCard))
      )
