...
export class AddBoardComponent {
  ...
  addBoardForm = this.fb.group({
    name: this.fb.control(this.data.board?.nameBoard, [Validators.required]),
  });
  ...
  private _updateBoard() {
    this.boardService
      .updateBoard(this.data.board?.idBoard, this.addBoardForm.value as ICreateBoard)
