...
function Subscription(nameOrType, options = {}) {
    return (target, key, descriptor) => {
        ...
        (0, resolvers_utils_1.addResolverMetadata)(resolver_enum_1.Resolver.SUBSCRIPTION, name, target, key, descriptor);
        (0, common_1.SetMetadata)(graphql_constants_1.SUBSCRIPTION_OPTIONS_METADATA, options)(target, key, descriptor);
