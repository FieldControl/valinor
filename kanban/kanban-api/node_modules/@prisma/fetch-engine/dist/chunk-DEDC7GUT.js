...
var chunk_DEDC7GUT_exports = {};
__export(chunk_DEDC7GUT_exports, {
  download: () => download,
...
module.exports = __toCommonJS(chunk_DEDC7GUT_exports);
var import_chunk_6IJFF4XW = require("./chunk-6IJFF4XW.js");
var import_chunk_MX3HXAU2 = require("./chunk-MX3HXAU2.js");
var import_chunk_U2R3HWVK = require("./chunk-U2R3HWVK.js");
var import_chunk_FAOLJN6R = require("./chunk-FAOLJN6R.js");
...
var require_stream = (0, import_chunk_QKHJU4HB.__commonJS)({
  "../../node_modules/.pnpm/execa@5.1.1/node_modules/execa/lib/stream.js"(exports, module2) {
    "use strict";
    var isStream = (0, import_chunk_FAOLJN6R.require_is_stream)();
...
var import_fs_extra = (0, import_chunk_QKHJU4HB.__toESM)((0, import_chunk_CUKHH27L.require_lib)());
var import_p_filter = (0, import_chunk_QKHJU4HB.__toESM)(require_p_filter());
var import_temp_dir = (0, import_chunk_QKHJU4HB.__toESM)((0, import_chunk_FAOLJN6R.require_temp_dir)());
...
async function download(options) {
  ...
  if (binariesToDownload.length > 0) {
    const cleanupPromise = (0, import_chunk_U2R3HWVK.cleanupCache)();
    let finishBar;
    let setProgress;
    ...
    const promises = binariesToDownload.map((job) => {
      const downloadUrl = (0, import_chunk_CUKHH27L.getDownloadUrl)({
        channel: "all_commits",
...
async function binaryNeedsToBeDownloaded(job, nativePlatform, version) {
  ...
  if (cachedFile) {
    if (job.skipCacheIntegrityCheck === true) {
      await (0, import_chunk_CUKHH27L.overwriteFile)(cachedFile, job.targetFilePath);
      return false;
    }
...
async function getCachedBinaryPath({
  ...
  const cacheDir = await (0, import_chunk_CUKHH27L.getCacheDir)(channel, version, binaryTarget2);
  if (!cacheDir) {
    return null;
  }
...
async function downloadBinary(options2) {
  ...
  const { sha256, zippedSha256 } = await (0, import_chunk_FAOLJN6R.downloadZip)(downloadUrl, targetFilePath, progressCb);
  if (progressCb) {
    progressCb(1);
  }
...
async function saveFileToCache(job, version, sha256, zippedSha256) {
  const cacheDir = await (0, import_chunk_CUKHH27L.getCacheDir)(channel, version, job.binaryTarget);
  if (!cacheDir) {
    return;
  }
  ...
  try {
    await (0, import_chunk_CUKHH27L.overwriteFile)(job.targetFilePath, cachedTargetPath);
    if (sha256 != null) {
