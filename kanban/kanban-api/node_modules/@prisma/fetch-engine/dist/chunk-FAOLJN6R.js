...
var require_del = (0, import_chunk_QKHJU4HB.__commonJS)({
  "../../node_modules/.pnpm/del@6.1.1/node_modules/del/index.js"(exports, module2) {
    ...
    var isGlob = require_is_glob();
    var slash = require_slash();
    var gracefulFs = (0, import_chunk_CUKHH27L.require_graceful_fs)();
...
async function downloadZip(url, target, progressCb) {
  ...
  await (0, import_chunk_CUKHH27L.overwriteFile)(partial, target);
  try {
    await del(partial);
    await del(tmpDir);
  } catch (e) {
