...
var chunk_7OFAX3XL_exports = {};
__export(chunk_7OFAX3XL_exports, {
  cleanupCache: () => cleanupCache
});
module.exports = __toCommonJS(chunk_7OFAX3XL_exports);
...
var import_p_map = (0, import_chunk_QKHJU4HB.__toESM)((0, import_chunk_CZYKYTO7.require_p_map)());
...
async function cleanupCache(n = 5) {
  try {
    const rootCacheDir = await (0, import_chunk_GZUBLM7I.getRootCacheDir)();
    if (!rootCacheDir) {
