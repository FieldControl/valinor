...
import { Transferable, Task, TaskQueue, kQueueOptions, kTransferable, kValue } from './common';
...
export { Piscina, kTransferable as transferableSymbol, kValue as valueSymbol, kQueueOptions as queueOptionsSymbol, version, FixedQueue };
