...
export class Mutation {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.0.0", ngImport: i0, type: Mutation, deps: [{ token: i1.Apollo }], target: i0.ɵɵFactoryTarget.Injectable });
