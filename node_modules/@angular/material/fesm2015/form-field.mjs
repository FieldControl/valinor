...
class MatFormField {
    ...
    set appearance(value) {
        ...
        const newAppearance = value || ((_a = this._defaults) === null || _a === void 0 ? void 0 : _a.appearance) || DEFAULT_APPEARANCE;
    ...
    get subscriptSizing() {
        var _a;
        return this._subscriptSizing || ((_a = this._defaults) === null || _a === void 0 ? void 0 : _a.subscriptSizing) || DEFAULT_SUBSCRIPT_SIZING;
    }
    set subscriptSizing(value) {
        var _a;
        this._subscriptSizing = value || ((_a = this._defaults) === null || _a === void 0 ? void 0 : _a.subscriptSizing) || DEFAULT_SUBSCRIPT_SIZING;
    }
    ...
    _updateFocusState() {
        ...
        if (this._control.focused && !this._isFocused) {
            ...
            (_a = this._lineRipple) === null || _a === void 0 ? void 0 : _a.activate();
        }
        else if (!this._control.focused && (this._isFocused || this._isFocused === null)) {
            this._isFocused = false;
            (_b = this._lineRipple) === null || _b === void 0 ? void 0 : _b.deactivate();
        }
        (_c = this._textField) === null || _c === void 0 ? void 0 : _c.nativeElement.classList.toggle('mdc-text-field--focused', this._control.focused);
    }
    /**
    ...
    _updateOutlineLabelOffset() {
        ...
        const iconPrefixContainer = (_a = this._iconPrefixContainer) === null || _a === void 0 ? void 0 : _a.nativeElement;
        const textPrefixContainer = (_b = this._textPrefixContainer) === null || _b === void 0 ? void 0 : _b.nativeElement;
        const iconPrefixContainerWidth = (_c = iconPrefixContainer === null || iconPrefixContainer === void 0 ? void 0 : iconPrefixContainer.getBoundingClientRect().width) !== null && _c !== void 0 ? _c : 0;
        const textPrefixContainerWidth = (_d = textPrefixContainer === null || textPrefixContainer === void 0 ? void 0 : textPrefixContainer.getBoundingClientRect().width) !== null && _d !== void 0 ? _d : 0;
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.0-rc.0", ngImport: i0, type: MatFormField, decorators: [{
        ...
        return [{ type: i0.ElementRef }, { type: i0.ChangeDetectorRef }, { type: i0.NgZone }, { type: i1.Directionality }, { type: i2.Platform }, { type: undefined, decorators: [{
                        type: Optional
                    }, {
                        type: Inject,
