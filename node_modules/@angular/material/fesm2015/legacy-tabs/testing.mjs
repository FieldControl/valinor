...
class MatLegacyTabGroupHarness extends ComponentHarness {
     ...
     */
    static with(options = {}) {
        return new HarnessPredicate(MatLegacyTabGroupHarness, options).addOption('selectedTabLabel', options.selectedTabLabel, (harness, label) => __awaiter(this, void 0, void 0, function* () {
...
class MatLegacyTabNavBarHarness extends ComponentHarness {
    ...
    getPanel() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.documentRootLocatorFactory().locatorFor(MatLegacyTabNavPanelHarness.with(filter))();
        });
    }
}
