...
export declare class AggregateQuerySnapshot<T extends AggregateSpec> {
    ...
    /** @hideconstructor */
    constructor(query: Query<unknown>, _userDataWriter: AbstractUserDataWriter, _data: ObjectValue);
    /**
 ...
 * @internal TODO (sum/avg) remove when public
 */
export declare function getAggregateFromServer<T extends AggregateSpec>(query: Query<unknown>, aggregateSpec: T): Promise<AggregateQuerySnapshot<T>>;
