 ...
 */ class Y {
    constructor(t, e, n, r) {
        this.t = t, this.i = e, this.o = n, this.u = r, this.type = "FirstParty", this.user = m.FIRST_PARTY, 
        this.h = new Map;
    }
...
class {
    ...
    A(t, e, n, r, s) {
        ...
        const o = {};
        return this.T(o, r, s), this.R(t, i, o, n).then((t => (_("RestConnection", "Received: ", t), 
        t)), (e => {
    ...
    async R(t, e, n, r) {
        ...
        try {
            ...
            const e = t;
            throw new B(yt(e.status), "Request failed with error: " + e.statusText);
        }
        if (!o.ok) {
            let t = await o.json();
            Array.isArray(t) && (t = t[0]);
            const e = null === (s = null == t ? void 0 : t.error) || void 0 === s ? void 0 : s.message;
            throw new B(yt(o.status), `Request failed with error: ${null != e ? e : o.statusText}`);
        }
        return o.json();
    }
}
...
function $t(t) {
    try {
        ...
        throw t instanceof h ? new Vt("Invalid base64 string: " + t) : t;
    }
}
...
class qt {
     ...
     *     date.
     */    static fromDate(t) {
        return qt.fromMillis(t.getTime());
    }
    /**
...
function Mt(t) {
    return "nullValue" in t ? 0 /* TypeOrder.NullValue */ : "booleanValue" in t ? 1 /* TypeOrder.BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* TypeOrder.NumberValue */ : "timestampValue" in t ? 3 /* TypeOrder.TimestampValue */ : "stringValue" in t ? 5 /* TypeOrder.StringValue */ : "bytesValue" in t ? 6 /* TypeOrder.BlobValue */ : "referenceValue" in t ? 7 /* TypeOrder.RefValue */ : "geoPointValue" in t ? 8 /* TypeOrder.GeoPointValue */ : "arrayValue" in t ? 9 /* TypeOrder.ArrayValue */ : "mapValue" in t ? Ot(t) ? 4 /* TypeOrder.ServerTimestampValue */ : 
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function Ut(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* TypeOrder.ArrayValue */ :
        return Tt(t.arrayValue.values || [], e.arrayValue.values || [], Ut);
...
function Bt(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* TypeOrder.GeoPointValue */ :
        return function(t, e) {
            const n = It(xt(t.latitude), xt(e.latitude));
            if (0 !== n) return n;
            return It(xt(t.longitude), xt(e.longitude));
...
function zt(t, e) {
    ...
    const n = Ft(t), r = Ft(e), s = It(n.seconds, r.seconds);
...
/** Creates a deep copy of `source`. */ function Ht(t) {
    ...
    if (t.mapValue) {
        ...
        return Pt(t.mapValue.fields, ((t, n) => e.mapValue.fields[t] = Ht(n))), e;
    }
    if (t.arrayValue) {
        const e = {
            arrayValue: {
...
class te extends Xt {
     ...
     */    static create(t, e, n) {
        return t.isKeyField() ? "in" /* Operator.IN */ === e || "not-in" /* Operator.NOT_IN */ === e ? this.createKeyFieldInFilter(t, e, n) : new re(t, e, n) : "array-contains" /* Operator.ARRAY_CONTAINS */ === e ? new ue(t, n) : "in" /* Operator.IN */ === e ? new ce(t, n) : "not-in" /* Operator.NOT_IN */ === e ? new ae(t, n) : "array-contains-any" /* Operator.ARRAY_CONTAINS_ANY */ === e ? new he(t, n) : new te(t, e, n);
    }
    static createKeyFieldInFilter(t, e, n) {
        return "in" /* Operator.IN */ === e ? new se(t, n) : new ie(t, n);
    }
    matches(t) {
        const e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* Operator.NOT_EQUAL */ === this.op ? null !== e && this.matchesComparison(Bt(e, this.value)) : null !== e && Mt(this.value) === Mt(e) && this.matchesComparison(Bt(e, this.value));
...
function ne(t, e) {
    return t instanceof te ? function(t, e) {
        return e instanceof te && t.op === e.op && t.field.isEqual(e.field) && Ut(t.value, e.value);
    }(t, e) : t instanceof ee ? function(t, e) {
        if (e instanceof ee && t.op === e.op && t.filters.length === e.filters.length) {
            return t.filters.reduce(((t, n, r) => t && ne(n, e.filters[r])), !0);
        }
        return !1;
    }
...
/** Filter that matches on key fields within an array. */ class se extends te {
    constructor(t, e) {
        super(t, "in" /* Operator.IN */ , e), this.keys = oe("in" /* Operator.IN */ , e);
    }
    matches(t) {
...
/** Filter that matches on key fields not present within an array. */ class ie extends te {
    constructor(t, e) {
        super(t, "not-in" /* Operator.NOT_IN */ , e), this.keys = oe("not-in" /* Operator.NOT_IN */ , e);
    }
    matches(t) {
        return !this.keys.some((e => e.isEqual(t.key)));
    }
...
/** A Filter that implements the array-contains operator. */ class ue extends te {
    constructor(t, e) {
        super(t, "array-contains" /* Operator.ARRAY_CONTAINS */ , e);
    }
    matches(t) {
        const e = t.data.field(this.field);
        return Wt(e) && jt(e.arrayValue, this.value);
    }
}
...
/** A Filter that implements the array-contains-any operator. */ class he extends te {
    constructor(t, e) {
        super(t, "array-contains-any" /* Operator.ARRAY_CONTAINS_ANY */ , e);
    }
    matches(t) {
        const e = t.data.field(this.field);
        return !(!Wt(e) || !e.arrayValue.values) && e.arrayValue.values.some((t => jt(this.value.arrayValue, t)));
    }
}
 ...
 */ class de {
    ...
    static min() {
        return new de(new qt(0, 0));
    }
    static max() {
        return new de(new qt(253402300799, 999999999));
    }
    compareTo(t) {
...
class we {
    ...
    insert(t, e) {
        return new we(this.comparator, this.root.insert(t, e, this.comparator).copy(null, null, pe.BLACK, null, null));
    }
    // Returns a copy of the map, with the specified key removed.
    remove(t) {
        return new we(this.comparator, this.root.remove(t, this.comparator).copy(null, null, pe.BLACK, null, null));
    }
...
class pe {
    constructor(t, e, n, r, s) {
        this.key = t, this.value = e, this.color = null != n ? n : pe.RED, this.left = null != r ? r : pe.EMPTY, 
        this.right = null != s ? s : pe.EMPTY, this.size = this.left.size + 1 + this.right.size;
    }
    // Returns a copy of the current node, optionally replacing pieces of it.
    copy(t, e, n, r, s) {
        return new pe(null != t ? t : this.key, null != e ? e : this.value, null != n ? n : this.color, null != r ? r : this.left, null != s ? s : this.right);
    }
    isEmpty() {
        return !1;
    }
    ...
    remove(t, e) {
        ...
        r = r.copy(null, null, null, r.left.remove(t, e), null); else {
            ...
            0 === e(t, r.key)) {
                if (r.right.isEmpty()) return pe.EMPTY;
...
class ye {
    ...
    getIterator() {
        return new ge(this.data.getIterator());
    }
    getIteratorFrom(t) {
        return new ge(this.data.getIteratorFrom(t));
    }
 ...
 */ class _e {
     ...
     */    unionWith(t) {
        let e = new ye(st.comparator);
        for (const t of this.fields) e = e.add(t);
        for (const n of t) e = e.add(n);
        return new _e(e.toArray());
    }
    /**
 ...
 */ class be {
     ...
     */    static newInvalidDocument(t) {
        return new be(t, 0 /* DocumentType.INVALID */ , 
        /* version */ de.min(), 
        /* readTime */ de.min(), 
        /* createTime */ de.min(), ve.empty(), 0 /* DocumentState.SYNCED */);
    }
    /**
     * Creates a new document that is known to exist with the given data at the
     * given version.
     */    static newFoundDocument(t, e, n, r) {
        return new be(t, 1 /* DocumentType.FOUND_DOCUMENT */ , 
        /* version */ e, 
        /* readTime */ de.min(), 
        /* createTime */ n, r, 0 /* DocumentState.SYNCED */);
    }
    /** Creates a new document that is known to not exist at the given version. */    static newNoDocument(t, e) {
        return new be(t, 2 /* DocumentType.NO_DOCUMENT */ , 
        /* version */ e, 
        /* readTime */ de.min(), 
        /* createTime */ de.min(), ve.empty(), 0 /* DocumentState.SYNCED */);
    }
     ...
     */    static newUnknownDocument(t, e) {
        return new be(t, 3 /* DocumentType.UNKNOWN_DOCUMENT */ , 
        /* version */ e, 
        /* readTime */ de.min(), 
        /* createTime */ de.min(), ve.empty(), 2 /* DocumentState.HAS_COMMITTED_MUTATIONS */);
    }
    /**
     ...
     */    convertToFoundDocument(t, e) {
        ...
        return !this.createTime.isEqual(de.min()) || 2 /* DocumentType.NO_DOCUMENT */ !== this.documentType && 0 /* DocumentType.INVALID */ !== this.documentType || (this.createTime = t), 
    ...
    setHasLocalMutations() {
        return this.documentState = 1 /* DocumentState.HAS_LOCAL_MUTATIONS */ , this.version = de.min(), 
        this;
    }
    setReadTime(t) {
    ...
    isEqual(t) {
        return t instanceof be && this.key.isEqual(t.key) && this.version.isEqual(t.version) && this.documentType === t.documentType && this.documentState === t.documentState && this.data.isEqual(t.data);
    }
    mutableCopy() {
        return new be(this.key, this.documentType, this.version, this.readTime, this.createTime, this.data.clone(), this.documentState);
    }
    toString() {
 ...
 * property.
 */ function Ae(t, e = null, n = [], r = [], s = null, i = null, o = null) {
 ...
 */ function Ve(t) {
    ...
    if (null === e.k) {
        ...
        t.isKeyField() || e.k.push(new le(t)), e.k.push(new le(st.keyField(), "asc" /* Direction.ASCENDING */)); else {
            let t = !1;
 ...
 */ function $e(t) {
    const e = T(t);
    if (!e.C) if ("F" /* LimitType.First */ === e.limitType) e.C = Ae(e.path, e.collectionGroup, Ve(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        // We need to swap the cursors to match the now-flipped query ordering.
                const n = e.endAt ? new Zt(e.endAt.position, e.endAt.inclusive) : null, r = e.startAt ? new Zt(e.startAt.position, e.startAt.inclusive) : null;
        // Now return as a LimitType.First query.
        e.C = Ae(e.path, e.collectionGroup, t, e.filters, e.limit, n, r);
    }
    return e.C;
}

function Ne(t, e) {
    e.getFirstInequalityField(), Re(t);
...
function De(t, e) {
    ...
    }($e(t), $e(e)) && t.limitType === e.limitType;
}
...
/** Transforms a value into a server-generated timestamp. */ class Se extends xe {}

/** Transforms an array value via a union operation. */ class qe extends xe {
    constructor(t) {
        super(), this.elements = t;
    }
}

/** Transforms an array value via a remove operation. */ class Oe extends xe {
    constructor(t) {
        super(), this.elements = t;
    }
}
 ...
 * limitations under the License.
 */
/** A field path and the TransformOperation to perform upon it. */ class Ce {
    constructor(t, e) {
...
/** A mutation that deletes the document at the given key. */ class Be extends Me {
    constructor(t, e) {
...
function Je(t) {
    return I(!!t), de.fromTimestamp(function(t) {
        const e = Ft(t);
        return new qt(e.seconds, e.nanos);
    }(t));
}
...
function on(t, e) {
    return "found" in e ? function(t, e) {
        ...
        const n = en(t, e.found.name), r = Je(e.found.updateTime), s = e.found.createTime ? Je(e.found.createTime) : de.min(), i = new ve({
            mapValue: {
                fields: e.found.fields
            }
        });
        return be.newFoundDocument(n, r, s, i);
    }(t, e) : "missing" in e ? function(t, e) {
        I(!!e.missing), I(!!e.readTime);
        const n = en(t, e.missing), r = Je(e.readTime);
        return be.newNoDocument(n, r);
    }(t, e) : A();
}

function un(t, e) {
    let n;
    if (e instanceof Ue) n = {
        update: sn(t, e.key, e.value)
    }; else if (e instanceof Be) n = {
        delete: tn(t, e.key)
    }; else if (e instanceof je) n = {
        update: sn(t, e.key, e.data),
        updateMask: wn(e.fieldMask)
    }; else {
        if (!(e instanceof ze)) return A();
        n = {
            verify: tn(t, e.key)
        };
    }
...
function cn(t, e) {
    ...
    const s = function(t) {
        ...
        return dn(ee.create(t, "and" /* CompositeOperator.AND */));
    }(e.filters);
...
function dn(t) {
    return t instanceof te ? function(t) {
    ...
    }(t) : t instanceof ee ? function(t) {
        const e = t.getFilters().map((t => dn(t)));
...
class yn {
     ...
     */    J(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                r > 0 && _("ExponentialBackoff", `Backing off for ${r} ms (base delay: ${this.K} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), 
...
class gn extends class {} {
    ...
    nt() {
        if (this.et) throw new B(O, "The client has already been terminated.");
    }
...
async function _n(t, e) {
    const n = T(t), r = rn(n.M) + "/documents", s = {
        writes: e.map((t => un(n.M, t)))
    };
...
async function bn(t, e) {
    const n = T(t), r = cn(n.M, $e(e));
    return (await n.P("RunQuery", r.parent, {
        structuredQuery: r.structuredQuery
    })).filter((t => !!t.document)).map((t => function(t, e, n) {
        const r = en(t, e.name), s = Je(e.updateTime), i = e.createTime ? Je(e.createTime) : de.min(), o = new ve({
            mapValue: {
                fields: e.fields
            }
        }), u = be.newFoundDocument(r, s, i, o);
...
async function En(t, e, n) {
    ...
    // Omit RunAggregationQueryResponse that only contain readTimes.
        return I(1 === o.length), (u = o[0]).result, u.result.aggregateFields, new ve({
        mapValue: {
...
function In(t) {
    ...
    if (!An.has(t)) {
        ...
        new X(e, n, r, s.host, s.ssl, s.experimentalForceLongPolling, s.experimentalAutoDetectLongPolling, s.useFetchStreams))), o = pn(t._databaseId), u = function(t, e, n, r) {
            return new gn(t, e, n, r);
 ...
 */ class Rn {
     ...
     */    _terminate() {
        return function(t) {
            const e = An.get(t);
            e && (_("ComponentProvider", "Removing Datastore"), An.delete(t), e.terminate());
 ...
 */ function $n(t, e, n, r = {}) {
    var s;
    const i = (t = ht(t, Rn))._getSettings();
 ...
 * terminated.
 */ function Nn(t) {
    return t = ht(t, Rn), e(t.app, "firestore/lite"), t._delete();
}
 ...
 */ class xn {
    ...
    withConverter(t) {
        return new xn(this.firestore, t, this._key);
    }
}
 ...
 */ class Sn {
    ...
    withConverter(t) {
        return new Sn(this.firestore, t, this._query);
    }
}
 ...
 */ class qn extends Sn {
    /** @hideconstructor */
    constructor(t, e, n) {
        super(t, e, new Ie(n)), this._path = n, 
        /** The type of this Firestore reference. */
     ...
     */    get parent() {
        ...
        return t.isEmpty() ? null : new xn(this.firestore, 
        /* converter= */ null, new it(t));
    }
    withConverter(t) {
        return new qn(this.firestore, t, this._path);
    }
}

function On(t, e, ...n) {
    if (t = d(t), ot("collection", "path", e), t instanceof Rn) {
        const r = nt.fromString(e, ...n);
        return ct(r), new qn(t, /* converter= */ null, r);
    }
    {
        if (!(t instanceof xn || t instanceof qn)) throw new B($, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const r = t._path.child(nt.fromString(e, ...n));
        return ct(r), new qn(t.firestore, 
        /* converter= */ null, r);
    }
}
 ...
 */ function kn(t, e) {
    if (t = ht(t, Rn), ot("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new B($, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new Sn(t, 
    /* converter= */ null, function(t) {
        return new Ie(nt.emptyPath(), t);
    }(e));
}
...
function Cn(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = At.F()), ot("doc", "path", e), t instanceof Rn) {
        const r = nt.fromString(e, ...n);
        return ut(r), new xn(t, 
        /* converter= */ null, new it(r));
    }
    {
        if (!(t instanceof xn || t instanceof qn)) throw new B($, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const r = t._path.child(nt.fromString(e, ...n));
        return ut(r), new xn(t.firestore, t instanceof qn ? t.converter : null, new it(r));
    }
}
 ...
 * Firestore database.
 */ function Ln(t, e) {
    return t = d(t), e = d(e), (t instanceof xn || t instanceof qn) && (e instanceof xn || e instanceof qn) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 * Firestore database.
 */ function Mn(t, e) {
    return t = d(t), e = d(e), t instanceof Sn && e instanceof Sn && (t.firestore === e.firestore && De(t._query, e._query) && t.converter === e.converter);
}
 ...
 */ class Un {
     ...
     */    static fromBase64String(t) {
        try {
            return new Un(Nt.fromBase64String(t));
        } catch (t) {
     ...
     */    static fromUint8Array(t) {
        return new Un(Nt.fromUint8Array(t));
    }
    /**
...
/** The result of parsing document data (e.g. for a setData call). */ class Gn {
    constructor(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    toMutation(t, e) {
        return null !== this.fieldMask ? new je(t, this.data, this.fieldMask, e, this.fieldTransforms) : new Ue(t, this.data, e, this.fieldTransforms);
    }
}
...
/** A "context" object passed around while parsing user data. */ class Hn {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */    it(t) {
        return new Hn(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.M, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
    }
    ot(t) {
        var e;
    ...
    lt(t) {
        return pr(t, this.settings.methodName, this.settings.ft || !1, this.path, this.settings.dt);
    }
    ...
    ct(t) {
        ...
        if (Yn(this.st) && Wn.test(t)) throw this.lt('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class Zn {
    constructor(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.M = n || pn(t);
    }
...
function Jn(t) {
    const e = t._freezeSettings(), n = pn(t._databaseId);
    return new Zn(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function Xn(t, e, n, r, s, i = {}) {
    const o = t.wt(i.merge || i.mergeFields ? 2 /* UserDataSource.MergeSet */ : 0 /* UserDataSource.Set */ , e, n, s);
    fr("Data must be an object, but it was:", o, r);
    const u = hr(r, o);
    let c, a;
    if (i.merge) c = new _e(o.fieldMask), a = o.fieldTransforms; else if (i.mergeFields) {
        const t = [];
        ...
        c = new _e(t), a = o.fieldTransforms.filter((t => c.covers(t.field)));
    } else c = null, a = o.fieldTransforms;
    return new Gn(new ve(u), c, a);
}
...
class rr extends zn {
    ...
    _toFieldTransform(t) {
        const e = er(this, t, 
        /*array=*/ !0), n = this.yt.map((t => ar(t, e))), r = new qe(n);
...
class sr extends zn {
    ...
    _toFieldTransform(t) {
        const e = er(this, t, 
        /*array=*/ !0), n = this.yt.map((t => ar(t, e))), r = new Oe(n);
        return new Ce(t.path, r);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class ir extends zn {
    ...
    _toFieldTransform(t) {
        const e = new ke(t.M, Fe(t.M, this.gt));
...
/** Parse update data from an update() call. */ function or(t, e, n, r) {
    const s = t.wt(1 /* UserDataSource.Update */ , e, n);
    fr("Data must be an object, but it was:", s, r);
    const i = [], o = ve.empty();
    Pt(r, ((t, r) => {
        const u = mr(e, t, n);
...
/** Parse update data from a list of field/value arguments. */ function ur(t, e, n, r, s, i) {
    const o = t.wt(1 /* UserDataSource.Update */ , e, n), u = [ dr(e, r, n) ], c = [ s ];
    ...
    for (let t = 0; t < i.length; t += 2) u.push(dr(e, i[t])), c.push(i[t + 1]);
    const a = [], h = ve.empty();
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (let t = u.length - 1; t >= 0; --t) if (!yr(a, u[t])) {
        const e = u[t];
        let n = c[t];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
 ...
 */ function cr(t, e, n, r = !1) {
    return ar(n, t.wt(r ? 4 /* UserDataSource.ArrayArgument */ : 3 /* UserDataSource.Argument */ , e));
}
 ...
 */ function ar(t, e) {
    ...
    // from firestore-exp.
    t = d(t))) return fr("Unsupported field value:", e, t), hr(t, e);
    if (t instanceof zn) 
 ...
 */
    return function(t, e) {
        ...
        if (!Yn(e.st)) throw e.lt(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        if ("number" == typeof t) return Fe(e.M, t);
        ...
        if (t instanceof qt) {
            ...
            const n = new qt(t.seconds, 1e3 * Math.floor(t.nanoseconds / 1e3));
            return {
                timestampValue: Ye(e.M, n)
            };
        }
        ...
        if (t instanceof Un) return {
            bytesValue: He(e.M, t._byteString)
        };
        if (t instanceof xn) {
        ...
        throw e.lt(`Unsupported field value: ${at(t)}`);
    }
    /**
...
function lr(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof qt || t instanceof Qn || t instanceof Un || t instanceof xn || t instanceof zn);
}
 ...
 */ function dr(t, e, n) {
    ...
    // FieldPath.
    e = d(e)) instanceof jn) return e._internalPath;
    if ("string" == typeof e) return mr(t, e);
    throw pr("Field path arguments must be of type string or ", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 * evaluated.
 */ function mr(t, e, n) {
    if (e.search(wr) >= 0) throw pr(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
        return new jn(...e.split("."))._internalPath;
    } catch (r) {
        throw pr(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`, t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
}
...
/** Checks `haystack` if FieldPath `needle` is present. Runs in O(n). */ function yr(t, e) {
 ...
 */ class gr {
     ...
     */    data() {
        if (this._document) {
            if (this._converter) {
                ...
                const t = new _r(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    get(t) {
        if (this._document) {
            const e = this._document.data.field(Er("DocumentSnapshot.get", t));
 ...
 */ function br(t, e) {
    return t = d(t), e = d(e), t instanceof gr && e instanceof gr ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof vr && e instanceof vr && (Mn(t.query, e.query) && Tt(t.docs, e.docs, br));
}

/**
 * Helper that calls `fromDotSeparatedString()` but wraps any error thrown.
 */ function Er(t, e) {
    return "string" == typeof e ? mr(t, e) : e instanceof jn ? e._internalPath : e._delegate._internalPath;
}
...
function Tr(t, e, ...n) {
    let r = [];
    e instanceof Ar && r.push(e), r = r.concat(n), function(t) {
        const e = t.filter((t => t instanceof Vr)).length, n = t.filter((t => t instanceof Rr)).length;
 ...
 */ class Rr extends Ir {
    ...
    _apply(t) {
        ...
        return Qr(t._query, e), new Sn(t.firestore, t.converter, Ne(t._query, e));
    }
    _parse(t) {
        const e = Jn(t.firestore), n = function(t, e, n, r, s, i, o) {
            let u;
            if (s.isKeyField()) {
                ...
                if ("in" /* Operator.IN */ === i || "not-in" /* Operator.NOT_IN */ === i) {
                    zr(o, i);
                    const e = [];
                    for (const n of o) e.push(Br(r, t, n));
                    u = {
                        arrayValue: {
                            values: e
                        }
            ...
            } else "in" /* Operator.IN */ !== i && "not-in" /* Operator.NOT_IN */ !== i && "array-contains-any" /* Operator.ARRAY_CONTAINS_ANY */ !== i || zr(o, i), 
            u = cr(n, e, o, 
            /* allowArrays= */ "in" /* Operator.IN */ === i || "not-in" /* Operator.NOT_IN */ === i);
            return te.create(s, i, u);
 ...
 */ function Pr(t, e, n) {
    const r = e, s = Er("where", t);
    return Rr._create(s, r, n);
}
 ...
 */ class Vr extends Ar {
    ...
    _parse(t) {
        ...
        return 1 === e.length ? e[0] : ee.create(e, this._getOperator());
    }
    _apply(t) {
        const e = this._parse(t);
        return 0 === e.getFilters().length ? t : (function(t, e) {
            ...
            for (const t of r) Qr(n, t), n = Ne(n, t);
        }
        // Checks if any of the provided filter operators are included in the given list of filters and
        // returns the first one that is, or null if none are.
        (t._query, e), new Sn(t.firestore, t.converter, Ne(t._query, e)));
    }
 ...
 */ function $r(...t) {
    ...
    return t.forEach((t => Gr("or", t))), Vr._create("or" /* CompositeOperator.OR */ , t);
}
 ...
 */ function Nr(...t) {
    // Only support QueryFilterConstraints
    return t.forEach((t => Gr("and", t))), Vr._create("and" /* CompositeOperator.AND */ , t);
}
 ...
 */ function Sr(t) {
    return lt("limit", t), xr._create("limit", t, "F" /* LimitType.First */);
}
 ...
 * @returns The created {@link QueryLimitConstraint}.
 */ function qr(t) {
    return lt("limitToLast", t), xr._create("limitToLast", t, "L" /* LimitType.Last */);
}
 ...
 */ class Or extends Ir {
    ...
    _apply(t) {
        const e = jr(t, this.type, this._docOrFields, this._inclusive);
        return new Sn(t.firestore, t.converter, function(t, e) {
...
function kr(...t) {
    return Or._create("startAt", t, 
    /*inclusive=*/ !0);
}

function Cr(...t) {
    return Or._create("startAfter", t, 
    /*inclusive=*/ !1);
}
...
function Mr(...t) {
    return Lr._create("endBefore", t, 
    /*inclusive=*/ !1);
}

function Ur(...t) {
    return Lr._create("endAt", t, 
    /*inclusive=*/ !0);
}

/** Helper function to create a bound from a document or fields */ function jr(t, e, n, r) {
    if (n[0] = d(n[0]), n[0] instanceof gr) return function(t, e, n, r, s) {
        ...
        // results.
                for (const n of Ve(t)) if (n.field.isKeyField()) i.push(Qt(e, r.key)); else {
            const t = r.data.field(n.field);
            if (Ot(t)) throw new B($, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === t) {
        ...
        return function(t, e, n, r, s, i) {
            ...
            for (let i = 0; i < s.length; i++) {
                ...
                if (o[i].field.isKeyField()) {
                    ...
                    if (!Pe(t) && -1 !== c.indexOf("/")) throw new B($, `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${r}() must be a plain document ID, but '${c}' contains a slash.`);
...
function Br(t, e, n) {
    if ("string" == typeof (n = d(n))) {
        ...
        if (!Pe(e) && -1 !== n.indexOf("/")) throw new B($, `Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
    ...
    if (n instanceof xn) return Qt(t, n._key);
...
function Gr(t, e) {
    if (!(e instanceof Rr || e instanceof Vr)) throw new B($, `Function ${t}() requires AppliableConstraints created with a call to 'where(...)', 'or(...)', or 'and(...)'.`);
}
...
class Yr extends class {
    convertValue(t, e = "none") {
        switch (Mt(t)) {
          ...
          case 6 /* TypeOrder.BlobValue */ :
            return this.convertBytes(St(t.bytesValue));
    ...
    convertGeoPoint(t) {
        return new Qn(xt(t.latitude), xt(t.longitude));
    }
    convertArray(t, e) {
    ...
    convertReference(t) {
        ...
        return new xn(this.firestore, /* converter= */ null, e);
    }
}
 ...
 * document contents.
 */ function Hr(t) {
    const e = In((t = ht(t, xn)).firestore), n = new Yr(t.firestore);
    return vn(e, [ t._key ]).then((e => {
        I(1 === e.length);
        const r = e[0];
        return new gr(t.firestore, n, t._key, r.isFoundDocument() ? r : null, t.converter);
    }));
}
 ...
 */ function Zr(t) {
    ...
    const e = In(t.firestore), n = new Yr(t.firestore);
    return bn(e, t._query).then((e => {
        const r = e.map((e => new _r(t.firestore, n, e.key, e, t.converter)));
        return "L" /* LimitType.Last */ === t._query.limitType && 
        // Limit to last queries reverse the orderBy constraint that was
        // specified by the user. As such, we need to reverse the order of the
        // results to return the documents in the expected order.
        r.reverse(), new vr(t, r);
    }));
}

function Jr(t, e, n) {
    const r = Kr((t = ht(t, xn)).converter, e, n), s = Xn(Jn(t.firestore), "setDoc", t._key, r, null !== t.converter, n);
    return _n(In(t.firestore), [ s.toMutation(t._key, Le.none()) ]);
}

function Xr(t, e, n, ...r) {
    const s = Jn((t = ht(t, xn)).firestore);
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
        let i;
    i = "string" == typeof (e = d(e)) || e instanceof jn ? ur(s, "updateDoc", t._key, e, n, r) : or(s, "updateDoc", t._key, e);
    return _n(In(t.firestore), [ i.toMutation(t._key, Le.exists(!0)) ]);
}
 ...
 */ function ts(t) {
    return _n(In((t = ht(t, xn)).firestore), [ new Be(t._key, Le.none()) ]);
}
 ...
 */ function es(t, e) {
    const n = Cn(t = ht(t, qn)), r = Kr(t.converter, e), s = Xn(Jn(t.firestore), "addDoc", n._key, r, null !== n.converter, {});
    return _n(In(t.firestore), [ s.toMutation(n._key, Le.exists(!1)) ]).then((() => n));
}
 ...
 */ function rs(t, e) {
    const n = ht(t.firestore, Rn), r = In(n), s = function(t, e) {
        const n = [];
    ...
    return En(r, t._query, s).then((e => function(t, e, n) {
        const r = new Yr(t);
        return new Fn(e, r, n);
    }
    /**
 ...
 * @internal TODO (sum/avg) remove when public
 */ function is(t) {
    return new Dn("avg", dr("average", t));
}
 ...
 * otherwise.
 */ function cs(t, e) {
    return Mn(t.query, e.query) && w(t.data(), e.data());
}
 ...
 */ class ws {
    ...
    constructor(t, e) {
        ...
        this._dataReader = Jn(t);
    }
    set(t, e, n) {
        this._verifyNotCommitted();
        const r = ms(t, this._firestore), s = Kr(r.converter, e, n), i = Xn(this._dataReader, "WriteBatch.set", r._key, s, null !== r.converter, n);
        return this._mutations.push(i.toMutation(r._key, Le.none())), this;
    }
    update(t, e, n, ...r) {
        this._verifyNotCommitted();
        const s = ms(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                let i;
        return i = "string" == typeof (e = d(e)) || e instanceof jn ? ur(this._dataReader, "WriteBatch.update", s._key, e, n, r) : or(this._dataReader, "WriteBatch.update", s._key, e), 
        this._mutations.push(i.toMutation(s._key, Le.exists(!0))), this;
    }
    /**
     ...
     */    delete(t) {
        this._verifyNotCommitted();
        const e = ms(t, this._firestore);
        return this._mutations = this._mutations.concat(new Be(e._key, Le.none())), this;
    }
    /**
 ...
 * writes.
 */ function ps(t) {
    const e = In(t = ht(t, Rn));
    return new ws(t, (t => _n(e, t)));
}
 ...
 */ class ys {
    ...
    async lookup(t) {
        ...
        const e = await vn(this.datastore, t);
    ...
    async commit() {
        ...
        t.forEach(((t, e) => {
            ...
            this.mutations.push(new ze(n, this.precondition(n)));
        })), await _n(this.datastore, this.mutations), this.committed = !0;
    }
    recordVersion(t) {
        let e;
     ...
     */    precondition(t) {
        ...
        return !this.writtenDocs.has(t.toString()) && e ? e.isEqual(de.min()) ? Le.exists(!1) : Le.updateTime(e) : Le.none();
    }
    /**
...
class _s {
    constructor(t, e, n, r, s) {
        ...
        this.deferred = s, this._t = n.maxAttempts, this.vt = new yn(this.asyncQueue, "transaction_retry" /* TimerId.TransactionRetry */);
    }
    ...
    bt() {
        this.vt.J((async () => {
            const t = new ys(this.datastore), e = this.Et(t);
            e && e.then((e => {
 ...
 * limitations under the License.
 */
/** The Platform's 'document' implementation or null if not available. */ function vs() {
 ...
 */ class bs {
     ...
     */    static createAndSchedule(t, e, n, r, s) {
        const i = Date.now() + n, o = new bs(t, e, i, r, s);
        return o.start(n), o;
    }
    /**
 ...
 */ class Es {
    constructor() {
        ...
        this.vt = new yn(this, "async_queue_retry" /* TimerId.AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.xt = () => {
            const t = vs();
            t && _("AsyncQueue", "Visibility state changed to " + t.visibilityState), this.vt.tt();
        };
        const t = vs();
    ...
    enqueue(t) {
        ...
        // advance the queue even when the operation is not run.
                const e = new z;
        return this.qt((() => this.Pt && this.Dt ? Promise.resolve() : (t().then(e.resolve, e.reject), 
 ...
 */ (t)) throw t;
 // Failure will be handled by AsyncQueue
    ...
    qt(t) {
        const e = this.Tt.then((() => (this.Nt = !0, t().catch((t => {
            this.$t = t, this.Nt = !1;
            const e = 
            /**
 ...
 */ (t);
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const r = bs.createAndSchedule(this, t, e, n, (t => this.kt(t)));
...
class As {
    /** @hideconstructor */
    constructor(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = Jn(t);
    }
    /**
     ...
     */    get(t) {
        const e = ms(t, this._firestore), n = new Yr(this._firestore);
        return this._transaction.lookup([ e._key ]).then((t => {
            if (!t || 1 !== t.length) return A();
            const r = t[0];
            if (r.isFoundDocument()) return new gr(this._firestore, n, r.key, r, e.converter);
            if (r.isNoDocument()) return new gr(this._firestore, n, e._key, null, e.converter);
            throw A();
        }));
    }
    set(t, e, n) {
        const r = ms(t, this._firestore), s = Kr(r.converter, e, n), i = Xn(this._dataReader, "Transaction.set", r._key, s, null !== r.converter, n);
    ...
    update(t, e, n, ...r) {
        ...
        // performing validation.
                let i;
        return i = "string" == typeof (e = d(e)) || e instanceof jn ? ur(this._dataReader, "Transaction.update", s._key, e, n, r) : or(this._dataReader, "Transaction.update", s._key, e), 
 ...
 */ function Is(t, e, n) {
    const r = In(t = ht(t, Rn)), s = Object.assign(Object.assign({}, gs), n);
    !function(t) {
        if (t.maxAttempts < 1) throw new B($, "Max attempts must be at least 1");
    }(s);
    const i = new z;
    return new _s(new Es, r, s, (n => e(new As(t, n))), i).run(), i.promise;
}
 ...
 */ !function(t) {
    ...
    const r = t.getProvider("app").getImmediate(), s = new Rn(new K(t.getProvider("auth-internal")), new J(t.getProvider("app-check-internal")), function(t, e) {
...
r("firestore-lite", "3.8.4", "rn"), r("firestore-lite", "3.8.4", "esm2017");

export { Dn as AggregateField, Fn as AggregateQuerySnapshot, Un as Bytes, qn as CollectionReference, xn as DocumentReference, gr as DocumentSnapshot, jn as FieldPath, zn as FieldValue, Rn as Firestore, B as FirestoreError, Qn as GeoPoint, Sn as Query, Vr as QueryCompositeFilterConstraint, Ir as QueryConstraint, _r as QueryDocumentSnapshot, Lr as QueryEndAtConstraint, Rr as QueryFieldFilterConstraint, xr as QueryLimitConstraint, Dr as QueryOrderByConstraint, vr as QuerySnapshot, Or as QueryStartAtConstraint, qt as Timestamp, As as Transaction, ws as WriteBatch, es as addDoc, us as aggregateFieldEqual, cs as aggregateQuerySnapshotEqual, Nr as and, fs as arrayRemove, ls as arrayUnion, is as average, On as collection, kn as collectionGroup, $n as connectFirestoreEmulator, os as count, ts as deleteDoc, as as deleteField, Cn as doc, Bn as documentId, Ur as endAt, Mr as endBefore, rs as getAggregate, ns as getCount, Hr as getDoc, Zr as getDocs, Vn as getFirestore, ds as increment, Pn as initializeFirestore, Sr as limit, qr as limitToLast, $r as or, Fr as orderBy, Tr as query, Mn as queryEqual, Ln as refEqual, Is as runTransaction, hs as serverTimestamp, Jr as setDoc, g as setLogLevel, br as snapshotEqual, Cr as startAfter, kr as startAt, ss as sum, Nn as terminate, Xr as updateDoc, Pr as where, ps as writeBatch };
