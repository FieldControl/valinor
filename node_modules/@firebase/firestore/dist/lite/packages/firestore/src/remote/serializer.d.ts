...
export declare function fromAggregationResult(aggregationQueryResponse: ProtoRunAggregationQueryResponse): ObjectValue;
...
export declare function toRunAggregationQueryRequest(serializer: JsonProtoSerializer, target: Target, aggregates: Aggregate[]): ProtoRunAggregationQueryRequest;
