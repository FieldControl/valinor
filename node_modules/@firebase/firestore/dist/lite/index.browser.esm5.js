 ...
 */ function Ae(t) {
    ...
    if (null === e.k) {
        ...
        n.isKeyField() || e.k.push(new ce(n)), e.k.push(new ce(rt.keyField(), "asc" /* Direction.ASCENDING */)); else {
 ...
 */ function Ie(t) {
    var e = I(t);
    if (!e.C) if ("F" /* LimitType.First */ === e.limitType) e.C = be(e.path, e.collectionGroup, Ae(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = Ae(e); r < i.length; r++) {
        ...
        // We need to swap the cursors to match the now-flipped query ordering.
                var u = e.endAt ? new Ht(e.endAt.position, e.endAt.inclusive) : null, s = e.startAt ? new Ht(e.startAt.position, e.startAt.inclusive) : null;
        // Now return as a LimitType.First query.
                e.C = be(e.path, e.collectionGroup, n, e.filters, e.limit, u, s);
    }
    return e.C;
}
...
}(), xe = function() {}, Me = /** @class */ function(e) {
    function n(t, n, r, i) {
        void 0 === i && (i = []);
        var o = this;
...
function He(t) {
    return A(!!t), fe.fromTimestamp(function(t) {
        var e = Vt(t);
        return new Ot(e.seconds, e.nanos);
    }(t));
}
...
function nn(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = $e(t, r), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = $e(t, r.popLast()), n.structuredQuery.from = [ {
        collectionId: r.lastSegment()
    } ]);
    var i = function(t) {
        if (0 !== t.length) return sn($t.create(t, "and" /* CompositeOperator.AND */));
    }(e.filters);
 ...
 */ var hn = /** @class */ function() {
     ...
     */ , i) {
        ...
        this.j = t, this.timerId = e, this.B = n, this.W = r, this.G = i, this.K = 0, this.Y = null, 
    ...
    t.prototype.J = function(t) {
        ...
        // honored as such).
        var n = Math.floor(this.K + this.X()), r = Math.max(0, Date.now() - this.H), i = Math.max(0, n - r);
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && b("ExponentialBackoff", "Backing off for ".concat(i, " ms (base delay: ").concat(this.K, " ms, delay with jitter: ").concat(n, " ms, last attempt: ").concat(r, " ms ago)")), 
        this.Y = this.j.enqueueAfterDelay(this.timerId, i, (function() {
    ...
    function n(t, n, r, i) {
        ...
        o.connection = r, o.M = i, o.et = !1, o;
    }
    return t(n, e), n.prototype.nt = function() {
        if (this.et) throw new B(C, "The client has already been terminated.");
    }, 
    /** Invokes the provided RPC with auth and AppCheck tokens. */ n.prototype.A = function(t, e, n) {
        var r = this;
        return this.nt(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((function(i) {
            var o = i[0], a = i[1];
            return r.connection.A(t, e, n, o, a);
        })).catch((function(t) {
...
function dn(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = I(t), i = tn(e.M) + "/documents", o = {
                ...
                return a = n.sent(), u = new Map, a.forEach((function(t) {
                    var n = function(t, e) {
                        return "found" in e ? function(t, e) {
                            ...
                            var n = Ze(t, e.found.name), r = He(e.found.updateTime), i = e.found.createTime ? He(e.found.createTime) : fe.min(), o = new ge({
                                mapValue: {
 ...
 */ function vn(t) {
    ...
    if (!mn.has(t)) {
        ...
        new Z(i, o, a, u.host, u.ssl, u.experimentalForceLongPolling, u.experimentalAutoDetectLongPolling, u.useFetchStreams))), n = fn(t._databaseId), r = function(t, e, n, r) {
 ...
 */ var gn = /** @class */ function() {
    function t(t) {
        ...
        this.useFetchStreams = !!t.useFetchStreams, function(t, e, n, r) {
            if (!0 === e && !0 === r) throw new B(V, "".concat("experimentalForceLongPolling", " and ").concat("experimentalAutoDetectLongPolling", " cannot be used together."));
 ...
 */ function Tn(t, e, n, r) {
    ...
    t._setSettings(Object.assign(Object.assign({}, o), {
        ...
        if ("string" == typeof r.mockUserToken) a = r.mockUserToken, u = v.MOCK_USER; else {
            ...
            if (!s) throw new B(V, "mockUserToken must contain 'sub' or 'user_id' field!");
            u = new v(s);
        }
        t._authCredentials = new G(new K(a, u));
    }
}
 ...
 */ function Pn(t, e) {
    ...
    if (!(t instanceof An || t instanceof Fn)) throw new B(V, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
 ...
 */ function Vn(t, e) {
    if (t = ct(t, wn), ot("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new B(V, "Invalid collection ID '".concat(e, "' passed to function collectionGroup(). Collection IDs must not contain '/'."));
    return new In(t, 
...
function Dn(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = Tt.F()), ot("doc", "path", e), t instanceof wn) {
        var o = et.fromString.apply(et, r([ e ], n, !1));
    ...
    if (!(t instanceof An || t instanceof Fn)) throw new B(V, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var a = t._path.child(et.fromString.apply(et, r([ e ], n, !1)));
    return at(a), new An(t.firestore, t instanceof Fn ? t.converter : null, new it(a));
}
 ...
 * Firestore database.
 */ function Nn(t, e) {
    return t = p(t), e = p(e), (t instanceof An || t instanceof Fn) && (e instanceof An || e instanceof Fn) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function On(t, e) {
    return t = p(t), e = p(e), t instanceof In && e instanceof In && t.firestore === e.firestore && function(t, e) {
        return function(t, e) {
...
/** A "context" object passed around while parsing user data. */ var zn = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.it = function(e) {
        ...
        return cr(t, this.settings.methodName, this.settings.ft || !1, this.path, this.settings.dt);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Bn(this.st) && Ln.test(t)) throw this.lt('Document fields cannot begin and end with "__"');
    }, t;
}(), Kn = /** @class */ function() {
    function t(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.M = n || fn(t)
...
var Hn = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new qe(t.M, Pe(t.M, this.gt));
...
/** Parse update data from an update() call. */ function $n(t, e, n, r) {
    ...
    var u = new ve(o);
    return new Un(a, u, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function tr(t, e, n, r, i, o) {
    var a = t.wt(1 /* UserDataSource.Update */ , e, n), u = [ ar(e, r, n) ], s = [ i ];
    ...
    for (var c = 0; c < o.length; c += 2) u.push(ar(e, o[c])), s.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var l = [], f = ge.empty(), h = u.length - 1; h >= 0; --h) if (!lr(l, u[h])) {
        var d = u[h], y = s[h];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        y = p(y);
 ...
 */ function er(t, e, n, r) {
    return void 0 === r && (r = !1), nr(n, t.wt(r ? 4 /* UserDataSource.ArrayArgument */ : 3 /* UserDataSource.Argument */ , e));
}
 ...
 */ function nr(t, e) {
    ...
    return function(t, e) {
        ...
        if (!Bn(e.st)) throw e.lt("".concat(t._methodName, "() can only be used with update() and set()"));
    ...
    return function(t, e) {
        ...
        if ("number" == typeof t) return Pe(e.M, t);
...
function ir(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof Ot || t instanceof Mn || t instanceof qn || t instanceof An || t instanceof xn);
}
 ...
 * evaluated.
 */ function sr(t, e, n) {
    if (e.search(ur) >= 0) throw cr("Invalid field path (".concat(e, "). Paths must not contain '~', '*', '/', '[', or ']'"), t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
 ...
 */
function dr(t, e) {
    return t = p(t), e = p(e), t instanceof fr && e instanceof fr ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof pr && e instanceof pr && On(t.query, e.query) && St(t.docs, e.docs, dr)
    /**
 * Helper that calls `fromDotSeparatedString()` but wraps any error thrown.
 */;
}
...
function yr(t, e) {
    return "string" == typeof e ? sr(t, e) : e instanceof Rn ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ var wr = /** @class */ function(e) {
    ...
    return t(n, e), n._create = function(t, e, r) {
        ...
        var e = this._parse(t);
        return Mr(t._query, e), new In(t.firestore, t.converter, Fe(t._query, e));
 ...
 */ var br = /** @class */ function(e) {
    ...
    return t(n, e), n._create = function(t, e) {
        ...
        }(t._query, e), new In(t.firestore, t.converter, Fe(t._query, e)));
...
function Or() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return Nr._create("endBefore", t, 
    /*inclusive=*/ !1);
}

function qr() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return Nr._create("endAt", t, 
    /*inclusive=*/ !0);
}
...
/** Helper function to create a bound from a document or fields */ function Rr(t, e, n, r) {
    if (n[0] = p(n[0]), n[0] instanceof fr) return function(t, e, n, r, i) {
        ...
        // results.
        for (var o = [], a = 0, u = Ae(t); a < u.length; a++) {
            var s = u[a];
...
function Cr(t, e, n) {
    ...
    if (n instanceof An) return zt(t, n._key);
...
function jr(t, e) {
    if (!(e instanceof wr || e instanceof br)) throw new B(V, "Function ".concat(t, "() requires AppliableConstraints created with a call to 'where(...)', 'or(...)', or 'and(...)'."));
}
...
var Br = /** @class */ function(e) {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        var n = this, r = {};
        return At(t.fields, (function(t, i) {
            r[t] = n.convertValue(i, e);
        })), r;
    }, t.prototype.convertGeoPoint = function(t) {
        return new Mn(Dt(t.latitude), Dt(t.longitude));
    ...
    return function(t, r) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = I(t), i = nn(e.M, Ie(r)), [ 4 /*yield*/ , e.P("RunQuery", i.parent, {
                  ...
                  case 1:
                    return [ 2 /*return*/ , n.sent().filter((function(t) {
                        ...
                        return function(t, e, n) {
                            var r = Ze(t, e.name), i = He(e.updateTime), o = e.createTime ? He(e.createTime) : fe.min(), a = new ge({
                                mapValue: {
                                    fields: e.fields
                                }
                            });
...
function Qr(t, e, n) {
    var r = Ur((t = ct(t, An)).converter, e, n), i = Gn(Qn(t.firestore), "setDoc", t._key, r, null !== t.converter, n);
...
function Gr(t, e, n) {
    ...
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
        return o = "string" == typeof (e = p(e)) || e instanceof Rn ? tr(a, "updateDoc", t._key, e, n, r) : $n(a, "updateDoc", t._key, e), 
 ...
 */ function Yr(t) {
    return dn(vn((t = ct(t, An)).firestore), [ new je(t._key, Ce.none()) ]);
}
 ...
 */ function Wr(t, e) {
    var n = Dn(t = ct(t, Fn)), r = Ur(t.converter, e), i = Gn(Qn(t.firestore), "addDoc", n._key, r, null !== n.converter, {});
 ...
 */ function Xr(t, r) {
    var i = ct(t.firestore, wn), o = vn(i), a = function(t, e) {
        ...
        return new _t(new wt(e), t._aggregateType, t._internalFieldPath);
    }));
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    }(e.M, Ie(r), i), a = o.parent, e.connection.v || delete o.parent, [ 4 /*yield*/ , e.P("RunAggregationQuery", a, o, /*expectedResponseCount=*/ 1) ];
 ...
 * otherwise.
 */ function ei(t, e) {
    return On(t.query, e.query) && m(t.data(), e.data());
}
 ...
 */ var ui = /** @class */ function() {
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        var r = si(t, this._firestore), i = Ur(r.converter, e, n), o = Gn(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        return this._mutations.push(o.toMutation(r._key, Ce.none())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        this._verifyNotCommitted();
        var o, a = si(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = p(e)) || e instanceof Rn ? tr(this._dataReader, "WriteBatch.update", a._key, e, n, r) : $n(this._dataReader, "WriteBatch.update", a._key, e), 
 ...
 */ var li = /** @class */ function() {
    ...
    function t(t, e, n, r, i) {
        ...
        this.deferred = i, this._t = n.maxAttempts, this.vt = new hn(this.asyncQueue, "transaction_retry" /* TimerId.TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.vt.J((function() {
            return e(t, void 0, void 0, (function() {
                var t, e, r = this;
                return n(this, (function(n) {
                    return t = new li(this.datastore), (e = this.Et(t)) && e.then((function(e) {
 ...
 */ var di, yi = /** @class */ function() {
    ...
    function t() {
        ...
        this.vt = new hn(this, "async_queue_retry" /* TimerId.AsyncQueueRetry */), 
    ...
    t.prototype.enqueueAndForget = function(t) {
        ...
        return this.qt((function() {
            return e.Pt && e.Nt ? Promise.resolve() : (t().then(n.resolve, n.reject), n.promise);
        })).then((function() {
            return n.promise;
        }));
    ...
    t.prototype.Ot = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (0 === this.Rt.length) return [ 3 /*break*/ , 5 ];
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.Rt[0]() ];

                  case 2:
                    return n.sent(), this.Rt.shift(), this.vt.reset(), [ 3 /*break*/ , 4 ];
        ...
        var e = this, n = this.Tt.then((function() {
 ...
 */
    ...
    t.prototype.Ct = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return [ 4 /*yield*/ , t = this.Tt ];

                  case 1:
                    e.sent(), e.label = 2;

                  case 2:
                    if (t !== this.Tt) return [ 3 /*break*/ , 0 ];
                    e.label = 3;
    ...
    /** Called once a DelayedOperation is run or canceled. */ t.prototype.kt = function(t) {
    ...
    return t.prototype.get = function(t) {
        var e = this, n = si(t, this._firestore), r = new Br(this._firestore);
        ...
        var r = si(t, this._firestore), i = Ur(r.converter, e, n), o = Gn(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = p(e)) || e instanceof Rn ? tr(this._dataReader, "Transaction.update", a._key, e, n, r) : $n(this._dataReader, "Transaction.update", a._key, e), 
...
di = "".concat(i, "_lite"), g = di, o(new c("firestore/lite", (function(t, e) {
    var n = e.instanceIdentifier, r = e.options, i = t.getProvider("app").getImmediate(), o = new wn(new Y(t.getProvider("auth-internal")), new J(t.getProvider("app-check-internal")), function(t, e) {
...
a("firestore-lite", "3.8.4", ""), a("firestore-lite", "3.8.4", "esm5");

export { Sn as AggregateField, kn as AggregateQuerySnapshot, qn as Bytes, Fn as CollectionReference, An as DocumentReference, fr as DocumentSnapshot, Rn as FieldPath, xn as FieldValue, wn as Firestore, B as FirestoreError, Mn as GeoPoint, In as Query, br as QueryCompositeFilterConstraint, vr as QueryConstraint, hr as QueryDocumentSnapshot, Nr as QueryEndAtConstraint, wr as QueryFieldFilterConstraint, Ar as QueryLimitConstraint, Sr as QueryOrderByConstraint, pr as QuerySnapshot, Pr as QueryStartAtConstraint, Ot as Timestamp, vi as Transaction, ui as WriteBatch, Wr as addDoc, ti as aggregateFieldEqual, ei as aggregateQuerySnapshotEqual, Er as and, oi as arrayRemove, ii as arrayUnion, Zr as average, Pn as collection, Vn as collectionGroup, Tn as connectFirestoreEmulator, $r as count, Yr as deleteDoc, ni as deleteField, Dn as doc, Cn as documentId, qr as endAt, Or as endBefore, Xr as getAggregate, Hr as getCount, zr as getDoc, Kr as getDocs, bn as getFirestore, ai as increment, _n as initializeFirestore, Ir as limit, Fr as limitToLast, Tr as or, kr as orderBy, gr as query, On as queryEqual, Nn as refEqual, gi as runTransaction, ri as serverTimestamp, Qr as setDoc, _ as setLogLevel, dr as snapshotEqual, Dr as startAfter, Vr as startAt, Jr as sum, En as terminate, Gr as updateDoc, _r as where, ci as writeBatch };
