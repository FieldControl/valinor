(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('sourcemap-codec'), require('@jridgewell/resolve-uri')) :
    typeof define === 'function' && define.amd ? define(['sourcemap-codec', '@jridgewell/resolve-uri'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.remapping = factory(global.sourcemapCodec, global.resolveURI));
}(this, (function (sourcemapCodec, resolveUri) { 'use strict';
    ...
    function decodeSourceMap(map) {
        ...
        if (typeof mappings === 'string') {
            mappings = sortMappings(sourcemapCodec.decode(mappings), true);
        }
        else {
